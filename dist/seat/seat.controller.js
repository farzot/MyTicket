...
let SeatController = class SeatController {
    ...
    updateIXtiyoriy(id, updateSeatDto) {
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Seat ni yaratish hisoblandi" }),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Seat ni  hammasini korish" }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: "List of Seat",
        type: [seat_model_1.Seat],
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Seat ni Edit qilish" }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: "List of Seat",
        type: seat_model_1.Seat,
    ...
    __metadata("design:returntype", void 0)
], SeatController.prototype, "updateIXtiyoriy", null);
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Seat ni delte qilish" }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: "List of Seat",
        type: seat_model_1.Seat,
