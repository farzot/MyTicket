...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Seat-type ni yaratish hisoblandi" }),
    (0, swagger_1.ApiResponse)({
        status: 201,
        description: "List of Seat-type",
        type: [seat_type_model_1.Seat_type],
    }),
    (0, common_1.Post)(),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Seat-type ni  hammasini korish" }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: "List of Seat=type",
        type: [seat_type_model_1.Seat_type],
