...
let CustomerAddressController = class CustomerAddressController {
    ...
    update(id, updateCustomerAddressDto) {
        return this.customerAddressService.updateCustomer_address(+id, updateCustomerAddressDto);
    }
    remove(id) {
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "create customer address" }),
    (0, swagger_1.ApiResponse)({
        status: 201,
        description: "The record has been successfully created.",
        type: customer_address_models_1.customer_address,
    }),
    (0, common_1.Post)(),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "getcustomer address" }),
    (0, swagger_1.ApiResponse)({
        status: 200,
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "getcustomer byId address" }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: "The record has been successfully get",
        type: customer_address_models_1.customer_address,
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "edit  customes_address" }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: "The record has been successfully get",
        type: customer_address_models_1.customer_address,
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "delete  customes_address" }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: "The record has been successfully get",
        type: customer_address_models_1.customer_address,
...
exports.CustomerAddressController = CustomerAddressController = __decorate([
    ...
    (0, swagger_1.ApiTags)("customer-address"),
