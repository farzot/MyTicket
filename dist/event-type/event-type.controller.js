...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "bu yerda post qilish hisoblanadi" }),
    (0, swagger_1.ApiResponse)({
        status: 201,
        description: "List of Event_type",
        type: [event_type_models_1.EventType],
    }),
    (0, common_1.Post)(),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "bu yerda getALl qilish hisoblanadi" }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: "List of Event_type",
        type: [event_type_models_1.EventType],
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "bu yerda getById qilish hisoblanadi" }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: "List of Event_type",
        type: event_type_models_1.EventType,
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "bu yerda edit qilish hisoblanadi" }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: "List of Event_type",
        type: event_type_models_1.EventType,
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "bu yerda delete qilish hisoblanadi" }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: "List of Event_type",
        type: event_type_models_1.EventType,
...
exports.EventTypeController = EventTypeController = __decorate([
    ...
    (0, swagger_1.ApiTags)("Event_type"),
