...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "Post qilinadi bu yerda" }),
    (0, swagger_1.ApiResponse)({
        status: 201,
        description: "List of Ticket",
        type: [ticket_models_1.Ticket],
    }),
    (0, common_1.Post)(),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [create_ticket_dto_1.default]),
    __metadata("design:returntype", void 0)
], TicketController.prototype, "create", null);
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "getALl qilinadi bu yerda" }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: "List of Ticket",
        type: [ticket_models_1.Ticket],
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "get ById qilinadi bu yerda" }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: "List of Ticket",
        type: ticket_models_1.Ticket,
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "edit  qilinadi bu yerda" }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: "List of Ticket",
        type: ticket_models_1.Ticket,
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "delete  qilinadi bu yerda" }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: "List of Ticket",
        type: ticket_models_1.Ticket,
