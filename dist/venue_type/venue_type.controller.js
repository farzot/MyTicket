...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "bu yerda post qilinad" }),
    (0, swagger_1.ApiResponse)({
        status: 201,
        description: "List of Venue_type",
        type: [venue_type_model_1.Venue_type],
    }),
    (0, common_1.Post)(),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "bu yerda getById qilinadi" }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: "List of Venue_type",
        type: venue_type_model_1.Venue_type,
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "bu yerda edit qilinadi" }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: "List of Venue_type",
        type: venue_type_model_1.Venue_type,
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: "bu yerda delete qilinadi" }),
    (0, swagger_1.ApiResponse)({
        status: 200,
        description: "List of Venue_type",
        type: venue_type_model_1.Venue_type,
...
exports.VenueTypeController = VenueTypeController = __decorate([
    ...
    (0, swagger_1.ApiTags)("venue-type"),
